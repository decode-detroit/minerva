...
use super::super::super::system_interface::{SystemSend, AllStop, Notification, Error, Warning, Current, Update};
...
impl ControlAbstraction {
    ...
    pub fn new(system_send: &SystemSend) -> ControlAbstraction {
        ...
        notification_title.set_markup("<span color='#338DD6' size='14000'>System Notifications</span>");
        ...
        notification_area.override_background_color(gtk::StateFlags::empty(), Some(&gdk::RGBA { red: 0.259, green: 0.259, blue: 0.259, alpha: 1.0 } )); // set background color
    ...
    fn unpack_notification(&self, notification: Notification) -> String {
        ...
        match notification {
            ...
            Error { message, time, } => {
                ...
                format!("{} — <span color='#FF3333'><b>Error: {}</b></span>\n", timestr, clean_text(&message, UPDATE_LIMIT, true, true, true))
            },
            ...
            Warning { message, time, } => {
                ...
                // Combine the message and the time
                format!("{} — <span color='#FFEE44'>Warning: {}</span>\n", timestr, clean_text(&message, UPDATE_LIMIT, true, true, true))
            },
            ...
            Current { message, time, } => {
                ...
                // Combine the message and the time
                return format!("{} — Event: <span color='#338DD6'>{}</span>\n", timestr, clean_text(&message, UPDATE_LIMIT, true, true, true));
            },
