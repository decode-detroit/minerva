...
use super::super::super::system_interface::{ItemId, ItemDescription, ItemPair, SystemSend, SceneChange, StatusChange, EditMode, AllStop, TriggerEvent, GetDescription, EditDetail, FullStatus, StatusDescription, EventDetail, EventDelay, DisplayControl, DisplayWith, DisplayDebug, LabelHidden, Hidden};
...
impl EditDialog {
    ...
    pub fn new(edit_mode: Rc<RefCell<bool>>, window: &gtk::ApplicationWindow) -> EditDialog {
        EditDialog { edit_mode,  window: window.clone() }
    }
    ...
    pub fn launch(&self, system_send: &SystemSend, checkbox: &SimpleAction) {
        ...
        let dialog = gtk::Dialog::new_with_buttons(
            ...
            &[("Cancel", gtk::ResponseType::Cancel.into()), ("Confirm", gtk::ResponseType::Ok.into())]
        );
...
impl StatusDialog {
    ...
    pub fn new() -> StatusDialog {
        StatusDialog { full_status: Rc::new(RefCell::new(FullStatus::default())) }
    }
    ...
    pub fn launch(&self, window: &gtk::ApplicationWindow, system_send: &SystemSend) {
        ...
        // Connect the close event for when the dialog is complete
        dialog.connect_response(clone!(status_selection, state_selection, system_send => move |modal, id| {
    ...
    pub fn update_state(&mut self, status_id: ItemPair, new_state: ItemPair) {
        ...
        if let Ok(mut full_status) = self.full_status.try_borrow_mut() {
            ...
            if let Some(&mut StatusDescription { ref mut current, .. }) = full_status.get_mut(&status_id) {
...
impl TriggerDialog {
    ...
    pub fn launch(&self, window: &gtk::ApplicationWindow, system_send: &SystemSend) {
        ...
        let event_lookup = gtk::Button::new_from_icon_name("edit-find", gtk::IconSize::Button.into());
...
impl InfoDialog {
    ...
    pub fn new(window: &gtk::ApplicationWindow) -> InfoDialog {
        InfoDialog { window: window.clone() }
    }
...
impl EditEventDialog {
    ...
    pub fn new(window: &gtk::ApplicationWindow) -> EditEventDialog {
        EditEventDialog { window: window.clone() }
    }
    ...
    /// create a new event.
    ///
    pub fn launch(&self, system_send: &SystemSend, old_pair: Option<ItemPair>, old_detail: Option<EventDetail>) {
        ...
        if let Some(detail) = old_detail {
            ...
            match detail {
                ...
                EventDetail::ModifyStatus { status_id, new_state } => {
                ...
                EventDetail::GroupedEvent { status_id, event_map } => {
...
impl EditOverview {
    ...
    fn new(system_send: &SystemSend, detail_stack: &gtk::Stack) -> EditOverview {
        ...
        let displaywith_lookup = gtk::Button::new_from_icon_name("edit-find", gtk::IconSize::Button.into());
        ...
        let displaydebug_lookup = gtk::Button::new_from_icon_name("edit-find", gtk::IconSize::Button.into());
    ...
    fn pack_pair(&self) -> (ItemPair, String) {
        ...
        let tmp_disp_id = self.display_type.get_active_id().unwrap_or(String::from("hidden"));
        let tmp_disp = match tmp_disp_id.as_str() {
            ...
            "displaycontrol" => {
                ...
                if self.displaycontrol_color_checkbox.get_active() {
                    let gdk::RGBA { red, green, blue, .. } = self.displaycontrol_color.get_rgba();
            ...
            "displaywith" => {
                ...
                if self.displaywith_color_checkbox.get_active() {
                    let gdk::RGBA { red, green, blue, .. } = self.displaywith_color.get_rgba();
                    color = Some(((red * 255.0) as u8, (green * 255.0) as u8, (blue * 255.0) as u8));
                }
            ...
            "displaydebug" => {
                ...
                if self.displaydebug_priority_checkbox.get_active() {
                    group_id = Some(ItemId::new_unchecked(self.displaydebug_spin.get_value() as u32));
                }
        ...
        (ItemPair::from_item(event_id, event_description), self.detail_selection.get_active_id().unwrap_or(String::from("scene")))
    }
}
...
impl EditNewScene {
    ...
    fn new(system_send: &SystemSend) -> EditNewScene {
        ...
        let new_scene_lookup = gtk::Button::new_from_icon_name("edit-find", gtk::IconSize::Button.into());
        ...
        EditNewScene { grid: new_scene_grid, new_scene_spin }
    }
...
impl EditModifyStatus{
    ...
    fn new(system_send: &SystemSend) -> EditModifyStatus {
        ...
        let status_id_lookup = gtk::Button::new_from_icon_name("edit-find", gtk::IconSize::Button.into());
        ...
        let state_id_lookup = gtk::Button::new_from_icon_name("edit-find", gtk::IconSize::Button.into());
        ...
        EditModifyStatus { grid: modify_status_grid, status_spin: status_id_spin, state_spin: state_id_spin }
    }
...
impl EditTriggerEvents {
    ...
    fn new(system_send: &SystemSend) -> EditTriggerEvents {
        ...
        EditTriggerEvents { grid: trigger_event_grid, trigger_event_list, system_send: system_send.clone() }
    }
    ...
    //
    fn add_event(trigger_event_list: &gtk::ListBox, event: Option<EventDelay>, system_send: &SystemSend) {
        ...
        let event_id_lookup = gtk::Button::new_from_icon_name("edit-find", gtk::IconSize::Button.into());
        ...
        let delete_button = gtk::Button::new_from_icon_name("edit-delete", gtk::IconSize::Button.into());
        ...
        if let Some(event_delay) = event {
            ...
            if let Some(delay) = event_delay.delay() { // May be and empty delay
...
impl EditSaveData {
    ...
    fn new(system_send: &SystemSend) -> EditSaveData {
        ...
        EditSaveData { grid: save_data_grid, save_data_list }
    }
...
impl EditGroupedEvent {
    ...
    fn new(system_send: &SystemSend) -> EditGroupedEvent {
        ...
        EditGroupedEvent { grid: grouped_event_grid, grouped_event_list, status_spin, system_send: system_send.clone() }
    }
    ...
    fn load_detail(&self, status_id: ItemId, event_map: FnvHashMap<ItemId, ItemId>) {
        ...
        for (state_id, event_id) in event_map.iter() {
            EditGroupedEvent::add_event(&self.grouped_event_list, Some(state_id.id()), Some(event_id.id()), &self.system_send);
        }
    }
    
    // A helper function to add a grouped event to the list
    fn add_event(grouped_event_list: &gtk::ListBox, state_id: Option<u32>, event_id: Option<u32>, system_send: &SystemSend) {
